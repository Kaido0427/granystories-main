...
<body style="background-color:  rgb(177, 111, 25);">
    ...
    <div class="book-container">
        <div id="book" class="book">
            ...
            <!-- anecdote -->
            @php
                $pageHeight = 400; // Hauteur approximative de la zone de contenu en pixels
                $fontSize = 6.5; // Taille de police
                $lineHeight = $fontSize * 1.5; // Hauteur de ligne
                $charsPerLine = floor(220 / ($fontSize * 0.5)); // Nombre de caractères par ligne
    ...
    <script>
        document.getElementById('download-pdf').addEventListener('click', function() {
            ...
            function addPage(index) {
                ...
                html2canvas(pages[index].querySelector('.front'), {
                    scale: 4, // Augmentation de l'échelle pour une meilleure qualité
                    useCORS: true,
                    logging: false,
                    letterRendering: true,
                    allowTaint: true,
                    foreignObjectRendering: true // Tente de préserver la qualité du texte
                }).then(canvas => {
                    ...
                    // Ajuster l'image pour qu'elle remplisse toute la page
